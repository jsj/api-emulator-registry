...
| <img src="https://www.google.com/s2/favicons?domain=goodreads.com&sz=64" width="32" height="32" alt=""> | [Goodreads](./providers/@goodreads/api-emulator/README.md) | `@api-emulator/goodreads` | Historical XML: book search, book details, authors, and user review lists. |
...
| <img src="https://www.google.com/s2/favicons?domain=microsoft.com&sz=64" width="32" height="32" alt=""> | [Microsoft](./providers/@microsoft/api-emulator/README.md) | `@api-emulator/microsoft` | Identity, tenant, user, and productivity APIs through Microsoft Graph-style surfaces. |
