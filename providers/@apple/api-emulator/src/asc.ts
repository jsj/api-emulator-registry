...
import { ascUserRoutes } from "./routes/auth.js";
...
export function seedASCDefaults(store: Store, _baseUrl: string): void {
...
export function registerASCRoutes(ctx: RouteContext): void {
...
export const ascPlugin: ServicePlugin = {
