  ...
  return {
    ...
    airports: {
      LHR: {
        ...
        city: 'London',
        state: 'England',
        timezone: { name: 'Europe/London', offset: 0 },
        runways: [
          { designator: '09L/27R', heading: 90, length: 12799, width: 164, elevation: 83, thr_coordinates: [51.4775, -0.4614], surface: { type: 'ASPH', description: 'Asphalt' } },
          { designator: '09R/27L', heading: 90, length: 12001, width: 164, elevation: 77, thr_coordinates: [51.4647, -0.434], surface: { type: 'ASPH', description: 'Asphalt' } },
        ],
      },
      JFK: {
        ...
        runways: [
          { designator: '04L/22R', heading: 44, length: 12079, width: 200, elevation: 12, thr_coordinates: [40.622, -73.785], surface: { type: 'CONC', description: 'Concrete' } },
          { designator: '13R/31L', heading: 134, length: 14511, width: 200, elevation: 13, thr_coordinates: [40.648, -73.816], surface: { type: 'CONC', description: 'Concrete' } },
        ],
      },
    },
    airlines: {
