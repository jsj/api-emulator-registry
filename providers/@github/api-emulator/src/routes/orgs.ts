import type { RouteContext, AuthUser } from "@api-emulator/core";
import { ApiError, parseJsonBody, parsePagination, setLinkHeader, unauthorized, forbidden } from "@api-emulator/core";
