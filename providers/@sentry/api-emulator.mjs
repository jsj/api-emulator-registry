...
export const contract = {
  ...
  scope: ['envelope-ingestion', 'store-ingestion', 'issue-grouping', 'issue-webhook-delivery', 'organizations', 'projects', 'releases', 'release-files', 'inspection'],
  fidelity: 'sdk-ingestion-and-rest-subset',
};
...
export const endpoints = 'SDK envelope/store ingestion, issue grouping, webhooks, releases, files, and inspection';
