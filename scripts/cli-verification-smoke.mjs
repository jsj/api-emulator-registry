...
import { s3Routes } from '../providers/@aws/api-emulator/src/routes/s3.ts';
import { plugin as appStoreConnectPlugin } from '../providers/@app-store-connect/api-emulator.mjs';
import { plugin as adyenPlugin } from '../providers/@adyen/api-emulator.mjs';
import { plugin as akamaiPlugin } from '../providers/@akamai/api-emulator.mjs';
import { plugin as alibabaCloudPlugin } from '../providers/@alibaba-cloud/api-emulator.mjs';
...
import { plugin as googlePlayPlugin } from '../providers/@google-play/api-emulator.mjs';
import { plugin as huggingFacePlugin } from '../providers/@huggingface/api-emulator.mjs';
import { plugin as kubernetesPlugin, seedFromConfig as seedKubernetes } from '../providers/@kubernetes/api-emulator/index.mjs';
import { plugin as linkedinPlugin } from '../providers/@linkedin/api-emulator.mjs';
import { plugin as lucentPlugin } from '../providers/@lucent/api-emulator.mjs';
import { plugin as metaPlugin, seedFromConfig as seedMeta } from '../providers/@meta/api-emulator.mjs';
import { plugin as nextdoorPlugin } from '../providers/@nextdoor/api-emulator.mjs';
import { plugin as oculusPlugin, seedFromConfig as seedOculus } from '../providers/@oculus/api-emulator.mjs';
import { plugin as playstationPlugin } from '../providers/@playstation/api-emulator.mjs';
import { plugin as snapPlugin, seedFromConfig as seedSnap } from '../providers/@snap/api-emulator.mjs';
import { plugin as appLovinPlugin, seedFromConfig as seedAppLovin } from '../providers/@applovin/api-emulator.mjs';
import { plugin as unityAdsPlugin } from '../providers/@unity-ads/api-emulator.mjs';
import { plugin as argoPlugin, seedFromConfig as seedArgo } from '../providers/@argo/api-emulator.mjs';
import { plugin as openaiPlugin } from '../providers/@openai/api-emulator.mjs';
import { plugin as plaidPlugin } from '../providers/@plaid/api-emulator/src/index.ts';
import { plugin as salesforcePlugin } from '../providers/@salesforce/api-emulator.mjs';
import { plugin as sentryPlugin } from '../providers/@sentry/api-emulator.mjs';
import { plugin as silurianPlugin } from '../providers/@silurian/api-emulator.mjs';
import { plugin as sierraPlugin } from '../providers/@sierra/api-emulator.mjs';
import { plugin as skyscannerPlugin } from '../providers/@skyscanner/api-emulator.mjs';
import { plugin as spotifyPlugin } from '../providers/@spotify/api-emulator.mjs';
import { plugin as supabasePlugin } from '../providers/@supabase/api-emulator.mjs';
import { plugin as elevenLabsPlugin } from '../providers/@elevenlabs/api-emulator.mjs';
import { plugin as falPlugin } from '../providers/@fal/api-emulator.mjs';
import { plugin as flightradar24Plugin } from '../providers/@flightradar24/api-emulator.mjs';
import { plugin as fireworksPlugin } from '../providers/@fireworks/api-emulator.mjs';
import { plugin as gcpPlugin } from '../providers/@gcp/api-emulator.mjs';
import { plugin as modalPlugin } from '../providers/@modal/api-emulator.mjs';
import { plugin as togetherAiPlugin } from '../providers/@togetherai/api-emulator.mjs';
import { plugin as sunoPlugin } from '../providers/@suno/api-emulator.mjs';
import { plugin as symbolabPlugin } from '../providers/@symbolab/api-emulator.mjs';
import { plugin as crusoePlugin } from '../providers/@crusoe/api-emulator.mjs';
import { plugin as coreweavePlugin } from '../providers/@coreweave/api-emulator.mjs';
import { plugin as tiktokPlugin, seedFromConfig as seedTikTok } from '../providers/@tiktok/api-emulator.mjs';
import { plugin as upstashPlugin } from '../providers/@upstash/api-emulator.mjs';
import { plugin as replicatePlugin } from '../providers/@replicate/api-emulator.mjs';
import { plugin as twilioPlugin, seedFromConfig as seedTwilio } from '../providers/@twilio/api-emulator/src/index.ts';
import { plugin as youtubePlugin } from '../providers/@youtube/api-emulator.mjs';
import { plugin as youtubeMusicPlugin } from '../providers/@youtube-music/api-emulator.mjs';
import { plugin as adpPlugin } from '../providers/@adp/api-emulator.mjs';
import { plugin as agentcardPlugin } from '../providers/@agentcard/api-emulator.mjs';
import { plugin as agentmailPlugin } from '../providers/@agentmail/api-emulator.mjs';
import { plugin as brexPlugin } from '../providers/@brex/api-emulator.mjs';
import { plugin as concurPlugin } from '../providers/@concur/api-emulator.mjs';
import { plugin as contextPlugin } from '../providers/@context/api-emulator.mjs';
import { plugin as coinbasePlugin } from '../providers/@coinbase/api-emulator.mjs';
import { plugin as datadogPlugin } from '../providers/@datadog/api-emulator.mjs';
import { plugin as dopplerPlugin } from '../providers/@doppler/api-emulator.mjs';
import { plugin as eTradePlugin } from '../providers/@e-trade/api-emulator.mjs';
import { plugin as grafanaPlugin } from '../providers/@grafana/api-emulator.mjs';
import { plugin as hashicorpVaultPlugin } from '../providers/@hashicorp-vault/api-emulator.mjs';
import { plugin as gustoPlugin } from '../providers/@gusto/api-emulator.mjs';
import { plugin as deelPlugin } from '../providers/@deel/api-emulator.mjs';
import { plugin as intuitPlugin } from '../providers/@intuit/api-emulator.mjs';
import { plugin as jiraPlugin } from '../providers/@jira/api-emulator.mjs';
import { plugin as joinwarpPayrollPlugin } from '../providers/@joinwarp-payroll/api-emulator.mjs';
import { plugin as mercuryPlugin } from '../providers/@mercury/api-emulator.mjs';
import { plugin as rampPlugin, seedFromConfig as seedRamp } from '../providers/@ramp/api-emulator.mjs';
import { plugin as ripplingPlugin } from '../providers/@rippling/api-emulator.mjs';
import { plugin as robinhoodTradingPlugin } from '../providers/@robinhood-trading/api-emulator.mjs';
import { plugin as samsaraPlugin } from '../providers/@samsara/api-emulator.mjs';
import { plugin as schwabPlugin } from '../providers/@schwab/api-emulator.mjs';
import { plugin as stainlessPlugin } from '../providers/@stainless/api-emulator.mjs';
import { plugin as turbotaxPlugin } from '../providers/@turbotax/api-emulator.mjs';
import { plugin as usaaPlugin } from '../providers/@usaa/api-emulator.mjs';
import { plugin as workdayPlugin } from '../providers/@workday/api-emulator.mjs';
import { plugin as xboxPlugin } from '../providers/@xbox/api-emulator.mjs';
import { plugin as lightreelPlugin } from '../providers/@lightreel/api-emulator.mjs';
import { plugin as listenLabsPlugin } from '../providers/@listenlabs/api-emulator.mjs';
import { plugin as snapprPlugin } from '../providers/@snappr/api-emulator.mjs';
import { plugin as qualtricsPlugin } from '../providers/@qualtrics/api-emulator.mjs';
import { plugin as surveyMonkeyPlugin } from '../providers/@surveymonkey/api-emulator.mjs';
import { plugin as azurePlugin } from '../providers/@azure/api-emulator.mjs';
import { plugin as backblazePlugin } from '../providers/@backblaze/api-emulator.mjs';
import { plugin as bunnyPlugin } from '../providers/@bunny/api-emulator.mjs';
import { plugin as digitalOceanPlugin } from '../providers/@digitalocean/api-emulator.mjs';
import { plugin as fastlyPlugin } from '../providers/@fastly/api-emulator.mjs';
import { plugin as googleMapsPlugin } from '../providers/@google-maps/api-emulator.mjs';
import { plugin as hetznerPlugin } from '../providers/@hetzner/api-emulator.mjs';
import { plugin as hostingerPlugin } from '../providers/@hostinger/api-emulator.mjs';
import { plugin as ionosPlugin } from '../providers/@ionos/api-emulator.mjs';
import { plugin as leasewebPlugin } from '../providers/@leaseweb/api-emulator.mjs';
import { plugin as linodePlugin } from '../providers/@linode/api-emulator.mjs';
import { plugin as ociPlugin } from '../providers/@oci/api-emulator.mjs';
import { plugin as ovhcloudPlugin } from '../providers/@ovhcloud/api-emulator.mjs';
import { plugin as protonMailPlugin } from '../providers/@proton-mail/api-emulator.mjs';
import { plugin as rackspacePlugin } from '../providers/@rackspace/api-emulator.mjs';
import { plugin as scalewayPlugin } from '../providers/@scaleway/api-emulator.mjs';
import { plugin as renderPlugin } from '../providers/@render/api-emulator.mjs';
import { plugin as upcloudPlugin } from '../providers/@upcloud/api-emulator.mjs';
import { plugin as vultrPlugin } from '../providers/@vultr/api-emulator.mjs';
import { plugin as imsgPlugin } from '../providers/@imsg/api-emulator.mjs';
import { plugin as yahooFinancePlugin } from '../providers/@yahoo-finance/api-emulator.mjs';
...
async function runStainlessCliSmoke(baseUrl) {
  ...
  try {
    ...
    const user = await run(go, [...common, 'user', 'retrieve'], { cwd: dir, env, timeout: 120_000 });
    assert.match(user.stdout, /ada@example\.test/);

    const projects = await run(go, [...common, 'projects', 'list', '--org', 'acme-corp'], { cwd: dir, env, timeout: 120_000 });
    assert.match(projects.stdout, /acme-api/);

    const project = await run(go, [...common, 'projects', 'retrieve', '--project', 'acme-api'], { cwd: dir, env, timeout: 120_000 });
    assert.match(project.stdout, /Acme API/);

    const branches = await run(go, [...common, 'projects:branches', 'list', '--project', 'acme-api'], { cwd: dir, env, timeout: 120_000 });
    assert.match(branches.stdout, /main/);

    const builds = await run(go, [...common, 'builds', 'list', '--project', 'acme-api', '--limit', '1'], { cwd: dir, env, timeout: 120_000 });
    assert.match(builds.stdout, /bui_emulator_/);

    const output = await run(go, [...common, 'builds:target-outputs', 'retrieve', '--project', 'acme-api', '--target', 'typescript', '--type', 'source', '--output', 'git'], { cwd: dir, env, timeout: 120_000 });
...
async function runAlpacaCliSmoke(baseUrl) {
  ...
  try {
    ...
    const fixedIncome = await runAlpaca(['data', 'fixed-income', 'latest-prices', '--isins', 'US9128285M81']);
...
async function builtSpogoCli(baseUrl) {
  ...
  try {
    ...
    if (sourceRoot && existsSync(join(sourceRoot, 'go.mod'))) {
      ...
      await run(git, ['clone', '--depth', '1', 'https://github.com/openclaw/spogo.git', root]);
    }
    ...
    const patchedFactorySource = factorySource.replace(
      ...
      'baseURL := os.Getenv("SPOGO_SPOTIFY_BASE_URL")\n\ttokenBaseURL := os.Getenv("SPOGO_SPOTIFY_TOKEN_BASE_URL")\n\treturn spotify.NewClient(spotify.Options{\n\t\tTokenProvider: spotify.CookieTokenProvider{Source: source, Timeout: c.Settings.Timeout, BaseURL: tokenBaseURL},\n\t\tBaseURL:       baseURL,',
    );
    if (patchedFactorySource === factorySource) {
      await rm(dir, { recursive: true, force: true });
      throw new Error('spogo localhost source patch no longer applies');
    }
    await writeFile(
      factoryPath,
    ...
    await run(go, ['build', '-o', path, './cmd/spogo'], { cwd: root, timeout: 120_000 });
    await chmod(path, 0o755);
...
async function runSpogoCliSmoke(baseUrl) {
  ...
  if (!cli) return null;
  try {
    const runSpogo = (args) => run(cli.path, args, { env: cli.env });
...
async function runSupabaseCliSmoke(baseUrl) {
  ...
  try {
    ...
    const installed = await commandPath('supabase');
    const supabase = await run(installed ?? 'npx', [...(installed ? [] : ['--yes', 'supabase']), '--profile', profilePath, 'projects', 'list', '-o', 'json'], {
...
async function runFalCliSmoke(baseUrl) {
...
async function main() {
  const providerFlag = process.argv.findIndex((arg) => arg === '--provider' || arg.startsWith('--provider='));
  const selectedProvider = providerFlag < 0 ? undefined : process.argv[providerFlag] === '--provider'
    ? process.argv[providerFlag + 1] : process.argv[providerFlag].slice('--provider='.length);
  if (providerFlag >= 0 && (!selectedProvider || selectedProvider.startsWith('--'))) throw new Error('--provider requires a provider name');
  if (selectedProvider) {
    const targeted = {
      alpaca: { plugin: alpacaPlugin, run: runAlpacaCliSmoke },
      stainless: { plugin: stainlessPlugin, run: runStainlessCliSmoke },
      spotify: { plugin: spotifyPlugin, run: runSpogoCliSmoke },
      supabase: { plugin: supabasePlugin, run: runSupabaseCliSmoke },
      fal: { plugin: falPlugin, run: runFalCliSmoke },
    }[selectedProvider];
    if (!targeted) throw new Error(`Targeted CLI smoke is not configured for ${selectedProvider}`);
    const app = createApp();
    const store = new Store();
    targeted.plugin.register(app, store);
    targeted.plugin.seed?.(store);
    await withServer(app, async (baseUrl) => {
      assert.ok(await targeted.run(baseUrl), `${selectedProvider} CLI unavailable or failed`);
    }, selectedProvider === 'fal' ? { port: Array.from({ length: 13 }, (_, offset) => 8787 + offset), host: '127.0.0.1' } : {});
    return;
  }
  const app = createApp();
  const store = new Store();
  ...
  await withServer(app, async (baseUrl) => {
    ...
    await runSupabaseCliSmoke(baseUrl);
  });
